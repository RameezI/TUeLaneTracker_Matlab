...
%% The Lane Filter Expressed in the VP Coordinate System %%
    ...
    global  LANE_CONF_THRESHOLD OBS_L OBS_R OBS_N  LANE_FILTER_OFFSET_V PX_STEP
    global  LANE_HISTOGRAM_BINS LANE_OFFSETS_BINS LANE_PRIOR LANE_TRANSITION LANE_FILTER
    ...
    LANE_HISTOGRAM_BINS      = -PX_MAX:PX_STEP:PX_MAX;                             %% Histogram bins for the lane observation model
    LANE_OFFSETS_BINS        = round([0:PX_STEP:PX_MAX]);                          %% Histogram bins for the 2D lane filter
    ...
    [OBS_L, OBS_R, OBS_N] = createLaneObservationModel( LANE_OFFSETS_BINS, LANE_HISTOGRAM_BINS, MIN_LANE_WIDTH, MAX_LANE_WIDTH, LANE_OFFSETS_BINS, CM_TO_PIXEL );
...
%% The VP Filter Expressed in the Center Image Coordinate System %%
    ...
    VP_BINS_HST        = round(LANE_HISTOGRAM_BINS * VP_LANE_RATIO);
