...
MAKEFILE = run_Init_State_mex.mk

include run_Init_State_mex.mki


SRC_FILES =  \
	run_Init_State_data.c \
	...
	sub2ind.c \
	imdilate.c \
	_coder_run_Init_State_info.c \
	_coder_run_Init_State_api.c \
	_coder_run_Init_State_mex.c \
	run_Init_State_emxutil.c

MEX_FILE_NAME_WO_EXT = run_Init_State_mex
MEX_FILE_NAME = $(MEX_FILE_NAME_WO_EXT).mexa64
TARGET = $(MEX_FILE_NAME)

SYS_LIBS = -lmwblas -lmwmorphop_flat_tbb -lmwnhood 
...
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/run_Init_State"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/run_Init_State/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/run_Init_State/%.cu
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/run_Init_State/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
