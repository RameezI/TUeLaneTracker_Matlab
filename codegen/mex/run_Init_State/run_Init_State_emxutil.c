...
void c_emxInitStruct_MatlabStruct_fo(const emlrtStack *sp,
  MatlabStruct_focusMask *pStruct, const emlrtRTEInfo *srcLocation, boolean_T
  doPush)
{
  emxInit_real_T(sp, &pStruct->FOCUS, 2, srcLocation, doPush);
}

void c_emxInitStruct_MatlabStruct_li(const emlrtStack *sp,
  MatlabStruct_likelihoods *pStruct, const emlrtRTEInfo *srcLocation, boolean_T
  doPush)
{
  emxInit_real_T1(sp, &pStruct->TOT_ALL, 3, srcLocation, doPush);
  emxInit_real_T(sp, &pStruct->TOT_MAX, 2, srcLocation, doPush);
  emxInit_real_T1(sp, &pStruct->GRADIENT_DIR_ALL, 3, srcLocation, doPush);
  emxInit_real_T(sp, &pStruct->GRADIENT_DIR_AVG, 2, srcLocation, doPush);
  emxInit_real_T1(sp, &pStruct->TOT_ALL_BACK_UP, 3, srcLocation, doPush);
  emxInit_real_T1(sp, &pStruct->GRADIENT_DIR_ALL_BACK_UP, 3, srcLocation, doPush);
  emxInit_real_T(sp, &pStruct->TOT_FOCUSED, 2, srcLocation, doPush);
}

void c_emxInitStruct_MatlabStruct_te(const emlrtStack *sp,
  MatlabStruct_templates *pStruct, const emlrtRTEInfo *srcLocation, boolean_T
  doPush)
{
  emxInit_real_T(sp, &pStruct->GRADIENT_DIR_ROOT, 2, srcLocation, doPush);
  emxInit_real_T(sp, &pStruct->PROB_ROOT, 2, srcLocation, doPush);
  emxInit_real_T(sp, &pStruct->DEPTH_ROOT, 2, srcLocation, doPush);
}
...
/* End of code generation (run_Init_State_emxutil.c) */
