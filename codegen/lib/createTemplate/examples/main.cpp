...
static void main_createTemplate();
...
static void main_createTemplate()
{
  ...
  emxInitArray_real32_T(&TEMPLATE, 2);

  // Initialize function 'createTemplate' input arguments.
  // Call the entry-point 'createTemplate'.
  createTemplate(argInit_real32_T(), argInit_real32_T(), TEMPLATE);
