 ...
 * File: _coder_VerifyLikelihoods_info.c
 *
...
/* Include Files */
#include "_coder_VerifyLikelihoods_info.h"
...
mxArray *emlrtMexFcnProperties()
{
  ...
  emlrtSetField(xEntryPoints, 0, "Name", mxCreateString("VerifyLikelihoods"));
...
/*
 * File trailer for _coder_VerifyLikelihoods_info.c
 *
 * [EOF]
 */
